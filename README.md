...
<!-- YOUTUBE:START -->
- [Live Coding: creiamo un servizio per la generazione di PDF](https://www.youtube.com/watch?v=anqV3zkeyrM)
...
1. 🚀 Published release [SimpleAuthenticationTools.Swashbuckle 3.0.12](https://github.com/marcominerva/SimpleAuthentication/releases/tag/swashbuckle_v3.0.12) in [marcominerva/SimpleAuthentication](https://github.com/marcominerva/SimpleAuthentication)
