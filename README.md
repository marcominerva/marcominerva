...
<!-- YOUTUBE:START -->
- [Live Coding: le novità di .NET 9.0 &lpar;seconda parte&rpar;](https://www.youtube.com/watch?v=hsrYjU4aQRY)
...
1. 🚀 Published release [SimpleAuthenticationTools.Abstractions 3.0.2](https://github.com/marcominerva/SimpleAuthentication/releases/tag/abstractions_v3.0.2) in [marcominerva/SimpleAuthentication](https://github.com/marcominerva/SimpleAuthentication)
